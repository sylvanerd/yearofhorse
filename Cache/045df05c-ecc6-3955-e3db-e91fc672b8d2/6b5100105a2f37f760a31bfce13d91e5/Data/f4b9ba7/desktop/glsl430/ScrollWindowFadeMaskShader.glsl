...
vec2 l9_3=windowSize*0.5;
vec2 l9_4=l9_1-vec2(0.5);
vec2 l9_5=((abs(l9_4*2.0)*(l9_3+vec2(radius)))-l9_3)+vec2(softness);
float l9_6=clamp(smoothstep(0.0,softness,(length(max(l9_5,vec2(0.0)))+min(max(l9_5.x,l9_5.y),0.0))-radius),0.0,1.0);
vec4 l9_7=vec4(Port_Value1_N001.x,Port_Value1_N001.y,Port_Value1_N001.z,vec4(0.0).w);
l9_7.w=l9_6;
...
{
l9_13=clamp(dot(l9_7.xyz,vec3(l9_6)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_6;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_6;
}
#else
{
float l9_17;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_7.xyz,vec3(0.33333001))*l9_6;
}
#else
{
float l9_21;
...
#endif
vec3 l9_28=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_7.xyz).xyz,vec3(l9_6));
