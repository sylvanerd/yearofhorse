...
float l9_8=step(0.99989998,varColor.x);
float l9_9=step(0.99989998,varColor.z);
float l9_10=max(size.y,size.z);
float l9_11=(-(l9_10/4.0))+(0.5*size.x);
vec3 l9_12;
vec3 l9_13;
vec3 l9_14;
if (l9_4)
...
l9_14=varTangent.xyz;
l9_13=varNormalAndMotion.xyz;
l9_12=(sc_ModelMatrix*vec4(((l9_7.x*mix(1.0,l9_10,1.0-step(l9_8+l9_9,0.0)))-mix(0.0,l9_11,l9_8))+mix(0.0,l9_11,l9_9),l9_7.y*l9_10,l9_7.z*l9_10,1.0)).xyz;
}
...
uniform vec3 Port_Normal_N033;
uniform float Port_Exponent_N033;
uniform float Port_Intensity_N033;
...
float l9_3=(Port_Value_N050+0.001)-0.001;
vec3 l9_4=vec3(min(smoothstep(Port_Input0_N046,Port_Input1_N046,l9_0.y*(1.0-(abs(l9_0.z)*Port_Input1_N007)))*l9_3,l9_3));
vec4 l9_5=vec4(l9_4.x,l9_4.y,l9_4.z,vec4(0.0).w);
l9_5.w=Port_Value2_N000;
vec4 l9_6=clamp((l9_5+(baseColor*vec4(max(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*Port_Normal_N033)),Port_Exponent_N033),0.0)*Port_Intensity_N033,Port_Input1_N058))))+vec4(0.001),Port_Input1_N042+vec4(0.001),Port_Input2_N042+vec4(0.001))-vec4(0.001);
float l9_7=l9_6.w;
...
{
l9_11=clamp(dot(l9_6.xyz,vec3(l9_7)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_7;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_7;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_16;
#if (sc_BlendMode_Add)
{
l9_16=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
...
{
l9_18=dot(l9_6.xyz,vec3(0.33333001))*l9_7;
}
#else
{
float l9_19;
#if (sc_BlendMode_Min)
{
l9_19=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_Max)
{
l9_20=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_20=1.0;
...
#endif
l9_8=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_9);
}
#else
{
vec4 l9_21;
...
#endif
vec3 l9_26=mix(l9_23.xyz,definedBlend(l9_23.xyz,l9_6.xyz).xyz,vec3(l9_7));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_7)),l9_7);
}
#else
{
vec4 l9_32;
...
#endif
l9_32=vec4(l9_6.xyz*l9_33,l9_33);
}
#else
{
l9_32=l9_6;
