...
vec2 l9_51=Globals.Surface_UVCoord1;
vec2 l9_52=((l9_51-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
vec4 l9_53;
#if (iconLayout==2)
{
bool l9_54=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_55=l9_52.x;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_56=l9_55;
float l9_57=l9_52.y;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_58=l9_57;
vec2 l9_59;
float l9_60;
...
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_62=l9_56;
float l9_63=1.0;
sc_ClampUV(l9_62,iconUvMinMax.x,iconUvMinMax.z,l9_61,l9_63);
float l9_64=l9_62;
float l9_65=l9_63;
bool l9_66;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_66=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_67=l9_58;
float l9_68=l9_65;
sc_ClampUV(l9_67,iconUvMinMax.y,iconUvMinMax.w,l9_66,l9_68);
l9_60=l9_68;
...
#endif
vec2 l9_69=sc_TransformUV(l9_59,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_70=l9_69.x;
float l9_71=l9_60;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_54,l9_71);
float l9_72=l9_69.y;
float l9_73=l9_71;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_54,l9_73);
float l9_74=l9_73;
vec3 l9_75=sc_SamplingCoordsViewToGlobal(vec2(l9_70,l9_72),iconLayout,iconGetStereoViewIndex());
vec4 l9_76=texture(iconArrSC,l9_75,0.0);
vec4 l9_77;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_77=mix(iconBorderColor,l9_76,vec4(l9_74));
}
#else
{
l9_77=l9_76;
...
#else
{
bool l9_78=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_79=l9_52.x;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_80=l9_79;
float l9_81=l9_52.y;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_82=l9_81;
vec2 l9_83;
float l9_84;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_86=l9_80;
float l9_87=1.0;
sc_ClampUV(l9_86,iconUvMinMax.x,iconUvMinMax.z,l9_85,l9_87);
float l9_88=l9_86;
float l9_89=l9_87;
bool l9_90;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_90=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_90=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_91=l9_82;
float l9_92=l9_89;
sc_ClampUV(l9_91,iconUvMinMax.y,iconUvMinMax.w,l9_90,l9_92);
l9_84=l9_92;
...
#endif
vec2 l9_93=sc_TransformUV(l9_83,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_94=l9_93.x;
float l9_95=l9_84;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_78,l9_95);
float l9_96=l9_93.y;
float l9_97=l9_95;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_78,l9_97);
float l9_98=l9_97;
vec3 l9_99=sc_SamplingCoordsViewToGlobal(vec2(l9_94,l9_96),iconLayout,iconGetStereoViewIndex());
vec4 l9_100=texture(icon,l9_99.xy,0.0);
vec4 l9_101;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_101=mix(iconBorderColor,l9_100,vec4(l9_98));
}
#else
{
l9_101=l9_100;
...
#endif
vec2 l9_102=step(l9_52,Port_Input1_N000);
vec2 l9_103=step(Port_Input0_N015,l9_52);
Value1=mix(l9_50,l9_53,vec4(max(l9_53.w-(((l9_102.x+l9_102.y)+l9_103.x)+l9_103.y),Port_Input1_N027)));
Result=Value1;
}
else
{
vec3 param_4;
Node70_Normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*Port_Import_N068,param_4,Globals);
vec3 l9_104=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(param_4,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_105;
#if (additional_settings_btn_refl_texLayout==2)
{
bool l9_106=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_107=l9_104.x;
sc_SoftwareWrapEarly(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_108=l9_107;
float l9_109=l9_104.y;
sc_SoftwareWrapEarly(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_110=l9_109;
vec2 l9_111;
float l9_112;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_113=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_113=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_114=l9_108;
float l9_115=1.0;
sc_ClampUV(l9_114,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_113,l9_115);
float l9_116=l9_114;
float l9_117=l9_115;
bool l9_118;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_118=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_118=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_119=l9_110;
float l9_120=l9_117;
sc_ClampUV(l9_119,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_118,l9_120);
l9_112=l9_120;
...
#endif
vec2 l9_121=sc_TransformUV(l9_111,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_122=l9_121.x;
float l9_123=l9_112;
sc_SoftwareWrapLate(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_106,l9_123);
float l9_124=l9_121.y;
float l9_125=l9_123;
sc_SoftwareWrapLate(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_106,l9_125);
float l9_126=l9_125;
vec3 l9_127=sc_SamplingCoordsViewToGlobal(vec2(l9_122,l9_124),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_128=texture(additional_settings_btn_refl_texArrSC,l9_127,0.0);
vec4 l9_129;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_129=mix(additional_settings_btn_refl_texBorderColor,l9_128,vec4(l9_126));
}
#else
{
l9_129=l9_128;
...
#else
{
bool l9_130=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_131=l9_104.x;
sc_SoftwareWrapEarly(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_132=l9_131;
float l9_133=l9_104.y;
sc_SoftwareWrapEarly(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_134=l9_133;
vec2 l9_135;
float l9_136;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_137=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_137=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_138=l9_132;
float l9_139=1.0;
sc_ClampUV(l9_138,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_137,l9_139);
float l9_140=l9_138;
float l9_141=l9_139;
bool l9_142;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_142=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_142=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_143=l9_134;
float l9_144=l9_141;
sc_ClampUV(l9_143,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_142,l9_144);
l9_136=l9_144;
...
#endif
vec2 l9_145=sc_TransformUV(l9_135,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_146=l9_145.x;
float l9_147=l9_136;
sc_SoftwareWrapLate(l9_146,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_130,l9_147);
float l9_148=l9_145.y;
float l9_149=l9_147;
sc_SoftwareWrapLate(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_130,l9_149);
float l9_150=l9_149;
vec3 l9_151=sc_SamplingCoordsViewToGlobal(vec2(l9_146,l9_148),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_152=texture(additional_settings_btn_refl_tex,l9_151.xy,0.0);
vec4 l9_153;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_153=mix(additional_settings_btn_refl_texBorderColor,l9_152,vec4(l9_150));
}
#else
{
l9_153=l9_152;
...
#endif
Default=vec4(Port_Import_N062)*l9_105;
Result=Default;
}
}
...
vec4 param_4;
Node16_If_else(0.0,vec4(0.0),vec4(0.0),param_4,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1));
vec4 l9_13=param_4;
mat3 l9_14=mat3(l9_6,l9_4,l9_5);
vec3 l9_15=-l9_2;
float l9_16=max(pow(1.0-abs(dot(l9_15,l9_14*Port_Normal_N010)),Port_Exponent_N010),0.0)*Port_Intensity_N010;
vec4 l9_17=l9_13+min(mix(baseColor*vec4(Port_Input1_N028),baseColor+((vec4(l9_16)*secondColor)*vec4(hasSecondColor)),vec4(l9_16*Port_Input1_N031)),Port_Input1_N023);
float l9_18=l9_17.w;
...
{
l9_24=clamp(dot(l9_17.xyz,vec3(l9_18)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_17.xyz,vec3(0.33333001)))*l9_18;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0))*l9_18;
}
#else
{
float l9_28;
...
#if (sc_BlendMode_Add)
{
l9_29=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_30=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*l9_18;
}
#else
{
float l9_31;
...
{
l9_31=dot(l9_17.xyz,vec3(0.33333001))*l9_18;
}
#else
{
float l9_32;
#if (sc_BlendMode_Min)
{
l9_32=1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_Max)
{
l9_33=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_33=1.0;
...
#endif
l9_21=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_17.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_22);
}
#else
{
vec4 l9_34;
...
#endif
vec3 l9_39=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_17.xyz).xyz,vec3(l9_18));
