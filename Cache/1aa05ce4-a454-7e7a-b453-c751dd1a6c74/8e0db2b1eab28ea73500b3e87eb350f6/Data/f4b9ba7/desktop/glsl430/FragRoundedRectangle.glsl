...
uniform float Port_radius_N007;
uniform float Port_borderSize_N007;
...
vec2 l9_3=l9_1*vec2(Port_Input1_N003);
vec2 l9_4=l9_3-vec2(1.0);
vec4 l9_5=vec4(l9_4.x,l9_4.y,vec4(0.0).z,vec4(0.0).w);
l9_5.z=Port_Value2_N006;
vec4 l9_6=l9_5;
l9_6.w=Port_Value3_N006;
vec4 l9_7=mix(Port_Input0_N000,l9_6,vec4(clamp(1.0-smoothstep(0.0,Port_borderSoftness_N007*2.0,length(max(((((abs(l9_4*(size+vec2(2.0)))-size)+vec2(Port_radius_N007))+vec2(Port_borderSize_N007))-vec2(2.0))+vec2(Port_borderSoftness_N007),vec2(0.0)))-Port_radius_N007),0.0,1.0)));
float l9_8=l9_7.w;
...
{
l9_14=clamp(dot(l9_7.xyz,vec3(l9_8)),0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_16=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_8;
}
#else
{
float l9_17;
...
{
l9_17=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_8;
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_8;
}
#else
{
float l9_19;
#if (sc_BlendMode_Add)
{
l9_19=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_20=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_8;
}
#else
{
float l9_21;
...
{
l9_21=dot(l9_7.xyz,vec3(0.33333001))*l9_8;
}
#else
{
float l9_22;
#if (sc_BlendMode_Min)
{
l9_22=1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_23;
#if (sc_BlendMode_Max)
{
l9_23=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_23=1.0;
...
#endif
l9_11=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_7.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_12);
}
#else
{
vec4 l9_24;
...
#endif
vec3 l9_29=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_7.xyz).xyz,vec3(l9_8));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_8)),l9_8);
}
#else
{
vec4 l9_35;
